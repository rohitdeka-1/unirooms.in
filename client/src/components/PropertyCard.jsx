        ...
        >
            <Link to={`/property/${propertyId}`}>
                ...
                <div className="relative h-52 overflow-hidden">
                    ...
                    {/* Favorite Button */}
                    <button className="absolute top-3 right-3 w-9 h-9 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-white transition-all duration-200">
                ...
                <div className="p-4">
                    ...
                    {/* Location */}
                    <p className="text-neutral-500 text-sm mb-2 flex items-center">
