                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <Link to="/" className="flex items-center space-x-2 mb-4">
                            ...
                            <span className="text-xl font-display font-bold">Unirooms</span>
                        </Link>
                        ...
                        <div className="flex space-x-3">
                            ...
                            <a href="https://instagram.com/unirooms.in" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-neutral-800 rounded-lg flex items-center justify-center hover:bg-primary-600 transition-colors">
                            ...
                            <a href="https://www.linkedin.com/company/unirooms-in" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-neutral-800 rounded-lg flex items-center justify-center hover:bg-primary-600 transition-colors">
                        ...
                        <button
                            ...
                            className="mt-4 w-full py-2.5 px-4 bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 rounded-xl text-white font-semibold text-sm flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-purple-500/30 transition-all duration-300 hover:scale-[1.02]"
                        >
                            <img src="/rmthunda.gif" alt="" className="w-14 h-10" />
                ...
                <div className="container mx-auto px-4 py-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className="text-neutral-500 text-sm">
                            © {currentYear} Unirooms. All rights reserved.
                        </p>
